...
class TestStockInvestor(TestCase):
    ...
    def test_search_auto_investing_mock_all_GPU(self):
        self.investor.search_auto_investing_mock_all(stored_model_only=True, update_stock=False, init_result=False,
                                                     cnt_to_del=0, start_divisor=6)

    def test_search_auto_investing_mock_all(self):
        tf.config.set_visible_devices([], 'GPU')
        self.test_search_auto_investing_mock_all_GPU()

    def test_search_auto_investing_mock_all_2(self):
        tf.config.set_visible_devices([], 'GPU')
        self.test_search_auto_investing_mock_all_GPU()
